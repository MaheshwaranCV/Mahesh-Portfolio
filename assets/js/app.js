...
<footer class="footer sticky-bottom"  style="background-color:#2b2a2a;">
  <div class="p-4">
    ...
    <a class="social-button twitter" href="https://twitter.com/maheshwarancv" target="_blank">
    ...
    <a class="social-button linkedin" href="https://www.linkedin.com/in/maheshwaran-cv/" target="_blank" >
    ...
    <a class="social-button github" href="https://github.com/MaheshwaranCV" target="_blank">
    <!-- SVG code for Github icon -->
